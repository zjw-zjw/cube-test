...
import com.kad.cube_test.hive.PhoenixToHivePartitionTable;
...
/**
 *  同步 Phoenix中 订单明细表 新增变化的记录 到 Hive分区表
 */
public class OdsOmOmOrderDetailIncrement {
    private static ParameterTool config;
    private static Logger log = LoggerFactory.getLogger(OdsOmOmOrderDetailIncrement.class);
    public static void main(String[] args) throws IOException, TableNotExistException {
        ...
        String hiveTable        = "ods_om_om_orderdetail_incr";
